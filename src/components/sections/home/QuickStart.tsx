  ...
  return (
    <SectionLight>
      <div>
          ...
          <BoundedContainer breakpoint="md" width="35%" margin="0 3rem 0 0">
            <ColumnCenter>
              ...
              <Paragraph>
                ...
                Praesent eget elit vel turpis malesuada vestibulum. Aliquam
                tincidunt tristique risus in vestibulum. Donec quis egestas
                eros. Vestibulum ac diam nec libero sodales venenatis sed in
                sem.
              </Paragraph>
            </ColumnCenter>
          </BoundedContainer>
        ...
        <FadedDiv>
          <Knob text="Lorem ipsum dolor sit amet" />
          <Knob text="Lorem ipsum dolor sit amet" />
          <Knob text="Lorem ipsum dolor sit amet" />
          <Knob text="Lorem ipsum dolor sit amet" />
          <Knob text="Lorem ipsum dolor sit amet" />
